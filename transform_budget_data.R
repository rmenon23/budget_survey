...
responses_df$valid_date_range = interval(mdy_hms("03/24/2017 14:00:00"),mdy_hms("03/30/2017 19:00:00"))
...
valid_response_df = valid_response_df %>%
  select(startdate,enddate,status,ipaddress,progress,`duration (in seconds)`,finished,recordeddate,responseid,recipientlastname,recipientfirstname,
    ...
    q3_9,q3_10,q3_20,q4_1,q4_17,q4_9,q4_2,q4_3,q4_4,q4_5,q4_6,q4_7,q4_12,q4_13,q4_31,q4_10,q4_30,q4_11,q4_8,q25,q6,q2,q12,q14_1,q14_2,q14_3,q14_4,
  ...
  rename(duration=`duration (in seconds)`,language=q18,community_role=q1,accept_central_office=q3_3,accept_athletic_cuts=q3_1,
    accept_consolidate_athletic_teams=q3_11,accept_eliminate_athletics=q3_5,accept_police_cuts=q3_2,accept_increase_class_size=q3_4,
    accept_close_schools=q3_7,accept_furlough=q3_8,accept_cut_counseling=q3_6,accept_cut_bus=q3_9,accept_cut_custodian=q3_10,
    accept_four_days=q3_20,rank_ms_athletic=q4_1,rank_consolidate_athletic=q4_17,rank_elim_ms_hs=q4_9,rank_elim_bus=q4_2,rank_elim_bus_extra=q4_3,
    ...
    community_role_sp=q12, accept_central_office_sp=q14_1, accept_athletic_cuts_sp=q14_2, accept_consolidate_athletic_teams_sp=q14_3,
    accept_eliminate_athletics_sp=q14_4, accept_police_cuts_sp=q14_5, accept_increase_class_size_sp=q14_10, accept_close_schools_sp=q14_11,
    accept_furlough_sp=q14_12, accept_cut_counseling_sp=q14_13, accept_cut_bus_sp=q14_14, accept_cut_custodian_sp=q14_15, accept_four_days_sp=q14_16,
...
# clean up responses for valid entries
responses_numeric_df$valid_date_range = interval(mdy_hms("03/24/2017 14:00:00"),mdy_hms("03/30/2017 19:00:00"))
...
valid_response_num_df = valid_response_num_df %>%
  select(startdate,enddate,status,ipaddress,progress,`duration (in seconds)`,finished,recordeddate,responseid,recipientlastname,recipientfirstname,
    ...
    q15_17,q15_18,q26,q20,q21) %>%
  rename(duration=`duration (in seconds)`,language=q18,community_role=q1,accept_central_office=q3_3,accept_athletic_cuts=q3_1,
    accept_cons_athletic_teams=q3_11,accept_eliminate_athletics=q3_5,accept_police_cuts=q3_2,accept_increase_class_size=q3_4,
    accept_close_schools=q3_7,accept_furlough=q3_8,accept_cut_counseling=q3_6,accept_cut_bus=q3_9,accept_cut_custodian=q3_10,
    accept_four_days=q3_20,rank_ms_athletic=q4_1,rank_consolidate_athletic=q4_17,rank_elim_ms_hs=q4_9,rank_elim_bus=q4_2,rank_elim_bus_extra=q4_3,
    rank_police=q4_4,rank_central_office=q4_5,rank_inc_1=q4_6,rank_inc_2=q4_7,rank_counseling=q4_12, rank_custodian=q4_13, rank_library=q4_31,
    rank_close_hs=q4_10, rank_consolidate_elem=q4_30, rank_furlough=q4_11, rank_four_days=q4_8, budget=q25, additional_input=q6, call_legistor=q2,
    community_role_sp=q12, accept_central_office_sp=q14_1, accept_athletic_cuts_sp=q14_2, accept_cons_athletic_teams_sp=q14_3,
    accept_eliminate_athletics_sp=q14_4, accept_police_cuts_sp=q14_5, accept_increase_class_size_sp=q14_10, accept_close_schools_sp=q14_11,
    accept_furlough_sp=q14_12, accept_cut_counseling_sp=q14_13, accept_cut_bus_sp=q14_14, accept_cut_custodian_sp=q14_15, accept_four_days_sp=q14_16,
    rank_ms_athletic_sp=q15_1, rank_consolidate_athletic_sp=q15_14, rank_elim_ms_hs_sp=q15_15, rank_elim_bus_sp=q15_3, rank_elim_bus_extra_sp=q15_4, rank_police_sp=q15_5,
    rank_central_office_sp=q15_6, rank_inc_1_sp=q15_7, rank_inc_2_sp=q15_8, rank_counseling_sp=q15_10, rank_custodian_sp=q15_11, rank_library_sp=q15_12, rank_close_hs_sp=q15_13,
